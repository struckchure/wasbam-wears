...
// node_modules/vue3-chart-v2/node_modules/chart.js/dist/Chart.js
var require_Chart = __commonJS({
  "node_modules/vue3-chart-v2/node_modules/chart.js/dist/Chart.js"(exports, module2) {
    (function(global, factory) {
      typeof exports === "object" && typeof module2 !== "undefined" ? module2.exports = factory(function() {
        try {
          return init_moment(), moment_exports;
        } catch (e) {
        }
      ...
      function getHsla(string) {
        ...
        if (match) {
          ...
          var h2 = scale(parseInt(match[1]), 0, 360), s = scale(parseFloat(match[2]), 0, 100), l = scale(parseFloat(match[3]), 0, 100), a = scale(isNaN(alpha) ? 1 : alpha, 0, 1);
          return [h2, s, l, a];
        }
      }
      function getHwb(string) {
        ...
        if (match) {
          var alpha = parseFloat(match[4]);
          var h2 = scale(parseInt(match[1]), 0, 360), w = scale(parseFloat(match[2]), 0, 100), b = scale(parseFloat(match[3]), 0, 100), a = scale(isNaN(alpha) ? 1 : alpha, 0, 1);
          return [h2, w, b, a];
        }
      }
      ...
      var Scale = core_element.extend({
        ...
        _tickSize: function() {
          ...
          return me.isHorizontal() ? h2 * cos > w * sin ? w / cos : h2 / sin : h2 * sin < w * cos ? h2 / cos : w / sin;
        },
        _isVisible: function() {
          var me = this;
          var chart = me.chart;
      ...
      var scale_radialLinear = scale_linearbase.extend({
        ...
        getBasePosition: function(index) {
          ...
          var min2 = me.min;
          var max2 = me.max;
          return me.getPointPositionForValue(index || 0, me.beginAtZero ? 0 : min2 < 0 && max2 < 0 ? max2 : min2 > 0 && max2 > 0 ? min2 : 0);
        },
        _drawGrid: function() {
          var me = this;
          var ctx = me.ctx;
        ...
        _drawLabels: function() {
          ...
          helpers$1.each(me.ticks, function(label, index) {
            ...
            if (tickOpts.showLabelBackdrop) {
              ...
              ctx.fillRect(-width / 2 - tickOpts.backdropPaddingX, -offset2 - tickFont.size / 2 - tickOpts.backdropPaddingY, width + tickOpts.backdropPaddingX * 2, tickFont.size + tickOpts.backdropPaddingY * 2);
            }
...
// node_modules/vue3-chart-v2/src/components/BaseChart.tsx
  ...
  return defineComponent({
    ...
    methods: {
      renderChart(userData, userOptions) {
        ...
        this.state.chartObj = new import_chart.default(ctx, {
          type: chartsType,
          data: userData,
          options: userOptions
        });
...
//! momentjs.com
//! version : 2.29.1
//# sourceMappingURL=vue3-chart-v2.js.map
